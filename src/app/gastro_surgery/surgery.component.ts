...
export class SurgeryComponent {
  constructor(private titleService: Title, private metaService: Meta) {
    this.titleService.setTitle("Best Gastroenterology Hospital in Jayanagar Bangalore | Aksha Hospital");

    this.metaService.updateTag({ name: 'description', content: 'Aksha is a leading gastroenterology hospital in Jayanagar Bangalore, offering expert care for digestive disorders with experienced specialists.' });

    this.metaService.updateTag({
      name: 'keywords', content: 'Best gastroenterology hospital in Bangalore, Gastroenterology hospital in Jayanagar, Advanced digestive care in Bangalore, Liver specialists in Jayanagar, Top gastroenterologists in Bangalore, Treatment for digestive disorders Bangalore, Gastro care near JP Nagar, Aksha Hospital gastroenterology services, Stomach and liver care in Jayanagar, Multispeciality hospital for GI care' }
