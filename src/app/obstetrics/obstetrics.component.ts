...
export class ObstetricsComponent {
  ...
  constructor(private titleService: Title, private metaService: Meta) {
    this.titleService.setTitle("Best Obstetrics & Gynecology Hospital in Jayanagar Bangalore | Aksha Hospital");

    this.metaService.updateTag({ name: 'description', content: 'Aksha hospital is one of the best gynecology hospitals in Jayanagar Bangalore, offering expert care in obstetrics, gynecology and high-risk pregnancies.' });

    this.metaService.updateTag({
      name: 'keywords', content: 'Best gynecology hospital in Bangalore, Obstetrics hospital in Jayanagar, Gynaecology care in Bangalore, Maternity hospital in Jayanagar, High- risk pregnancy care in Bangalore, Women’s health specialists in Bangalore, Advanced gynecological treatments, Top obstetricians in Jayanagar, Best OBG hospital near JP Nagar, Gynaecology services in Banashankari' }
